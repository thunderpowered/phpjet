...
<html style="background-color:#fff">
    ...
    <head>
        <title>Учётная запись активирована. Вы будете перенаправлены автоматически.</title>
    ...
    <div class="page-empty text-center">
        <h1>Учётная запись активирована. Вы будете перенаправлены автоматически.</h1>
