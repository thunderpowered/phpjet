...
export class Start extends Component {
    ...
    onClick() {
        if (!this.showStartMenu) {
            this.props.onClickStart(true)
        }
    }

    render() {
        this.showStartMenu = this.props.showStartMenu;
        return <div onClick={() => this.onClick()} className='Desktop__Workspace__Blocks--TaskBar__Start p-4 pt-2 pb-2 m-0 theme__background-color--hover-soft cursor-pointer' id={'Start'}>
