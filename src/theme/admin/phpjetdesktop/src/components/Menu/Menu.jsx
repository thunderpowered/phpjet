            ...
            <div className="container h-100">
                <div className="row h-100">
                    <div className="col-lg-12 col-md-12 col-sm-12 h-100 p-0 d-flex flex-column justify-content-end">
                        <div onClick={e => e.stopPropagation()} className="menu__inner mb-5 pb-2 d-flex flex-column justify-content-end">
                            {/* header */}
                            ...
                            {/* menu list */}
                            <div className="menu__list custom-scroll" ref={menuRef}>
                                {/* actual menu list */}
                                {list && list.length > 0 &&
                                    list.map(item => (
                                        <MenuItem
